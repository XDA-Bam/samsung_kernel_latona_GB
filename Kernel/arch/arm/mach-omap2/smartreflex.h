...
#define PRM_VP1_CONFIG_ERRORGAIN_OPP1		(0x0C << 16)
#define PRM_VP1_CONFIG_ERRORGAIN_OPP2		(0x16 << 16)
#define PRM_VP1_CONFIG_ERRORGAIN_OPP3		(0x23 << 16)
#define PRM_VP1_CONFIG_ERRORGAIN_OPP4		(0x27 << 16)
...
#define PRM_VP2_CONFIG_ERRORGAIN_OPP1		(0x0C << 16)
#define PRM_VP2_CONFIG_ERRORGAIN_OPP2		(0x16 << 16)
...
#define SR1_ERRMINLIMIT_OPP1		(0xF4 << 0)
#define SR1_ERRMINLIMIT_OPP2		(0xF9 << 0)
#define SR1_ERRMINLIMIT_OPP3		(0xFA << 0)
#define SR1_ERRMINLIMIT_OPP4		(0xFA << 0)
#define SR1_ERRMINLIMIT_OPP5		(0xFA << 0)
#define SR1_IRQ				18
...
#define SR2_ERRMINLIMIT_OPP1		(0xF4 << 0)
#define SR2_ERRMINLIMIT_OPP2		(0xF9 << 0)
#define SR2_IRQ				19
