...
// Key LED controller
#define KEYLED_EN               OMAP_GPIO_KEY_LED_EN
...
#define QT602240_BOOT_HIGH		0x25
 ...
 /* Firmware */
#define BUILTIN_FIRMWARE_VERSION QT602240_VER_22
...
#define REPORTID_NOISESUPPRESSION 15
 ...
 typedef struct
 {
    ...
    uint8_t mvdthr1;               /*!< Movement detection threshold */
    uint8_t mvdthr2;               /*!< Movement detection threshold */
