...
static u16 LCD_HBP =	20;
static u16 LCD_HFP =	20;
static u16 LCD_HSW =	2;
static u16 LCD_VBP =	8;
static u16 LCD_VFP =	4;
...
void nt35510_ldi_poweron_sony(void)
{
	...
	spi1writeindex(0x36);
	spi1writedata(0xD4); // spi1writedata(0xC0);
	...
	spi1writeindex(0xB8);
	spi1writedata(0x0C); // 480*800
	spi1writedata(0x10); // DBI Type C(option1) 3-wire 9-bit interface I 
	...
	spi1writeindex(0xC0);
	spi1writedata(0x80);  // 0x80
	spi1writedata(0x80); // 0x10  
	...
	spi1writedata(0x00);
	spi1writedata(0x30); 
	spi1writedata(0x84); // 0x88 
	spi1writedata(0x84); // 0x88
	spi1writedata(0x57); 
	spi1writedata(0x57); 
	spi1writedata(0x10); // 0x00
	spi1writedata(0x41); 
	spi1writedata(0x00); 
