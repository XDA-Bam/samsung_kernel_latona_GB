...
#if 0 // commented for zeus
extern int 					debug_check(unsigned int flag);

#define	dprintk(x, y...)	\
	do{\
	if(unlikely(debug_check(x)))printk("["#x"] "y);\
	}while(0)
#else
...
#define DCM_INP			0x0000000000000001
#define DCM_ERR			0x0000000000000002
...
#define MF_DCM_USB		USB_DBG
#define MF_CAM_DBG		CAM_DBG
#endif
