...
LINK2=$(/sbin/ext/busybox find /system/xbin/busybox -type l);
if /sbin/ext/busybox [ "$LINK2" == "/system/xbin/busybox" ]; then
...
# patch if busybox not found in /system/xbin
if /sbin/ext/busybox [ ! -f /system/xbin/busybox ]; then
